...
namespace Manga.Infrastructure.EntityFrameworkDataAccess.Migrations
{
    ...
    [Migration("20190712052557_Add_SSN")]
    partial class Add_SSN
    {
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 12, 5, 25, 57, 358, DateTimeKind.Utc).AddTicks(8820)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 12, 5, 25, 57, 359, DateTimeKind.Utc).AddTicks(751)
                        });
                });
