...
namespace Manga.Infrastructure.EntityFrameworkDataAccess.Migrations
{
    ...
    [Migration("20190714120331_NewUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 14, 12, 3, 30, 942, DateTimeKind.Utc).AddTicks(905)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 14, 12, 3, 30, 942, DateTimeKind.Utc).AddTicks(4551)
                        });
                });

            modelBuilder.Entity("Manga.Infrastructure.EntityFrameworkDataAccess.Basic.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Manga.Infrastructure.EntityFrameworkDataAccess.Basic.ApplicationUser")
                        .WithMany()
