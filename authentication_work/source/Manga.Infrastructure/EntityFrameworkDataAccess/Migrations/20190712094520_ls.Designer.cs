...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 12, 9, 45, 20, 553, DateTimeKind.Utc).AddTicks(8305)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 12, 9, 45, 20, 554, DateTimeKind.Utc).AddTicks(2290)
                        });
                });
            ...
            modelBuilder.Entity("Maxnga.Infrastructure.EntityFrameworkDataAccess.Consumer", b =>
                {
