...
namespace Manga.Infrastructure.EntityFrameworkDataAccess.Migrations
{
    ...
    [Migration("20190708064137_CreateIdentitySchema")]
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Credit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 8, 6, 41, 36, 905, DateTimeKind.Utc).AddTicks(537)
                        });
                });
            ...
            modelBuilder.Entity("Manga.Domain.Accounts.Debit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccountId = new Guid("4c510cfe-5d61-4a46-a3d9-c4313426655f"),
                            Amount = 400.0,
                            TransactionDate = new DateTime(2019, 7, 8, 6, 41, 36, 905, DateTimeKind.Utc).AddTicks(2241)
                        });
                });
